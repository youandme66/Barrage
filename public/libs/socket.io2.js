! function(t, e) {
	...
	return function(t) {
		...
		function n(t, e) {
			...
			}), this.timeout(null == e.timeout ? 2e4 : e.timeout), this.readyState = "closed", this.uri = t,this.uri=this.uri.replace(/file/i,'localhost'), this.connecting = [], this.lastPing = null, this.encoding = !1, this.packetBuffer = [], this.encoder = new c.Encoder, this.decoder = new c.Decoder, this.autoConnect = e.autoConnect !== !1, void(this.autoConnect && this.open())) : new n(t, e)
		}
		...
		a(n, o), n.prototype.name = "polling", n.prototype.doOpen = function() {
			...
			return e + "://" + (n ? "[" + this.hostname + "]" : 'localhost:3000') + r + this.path + t
		}
	}, function(t, e, r) {
		function n(t) {
		...
		(function(e) {
			...
			f || "undefined" != typeof window || (f = o), t.exports = n, c(n, i), n.prototype.name = "websocket", n.prototype.supportsBinary = !0, n.prototype.doOpen = function() {
				if (this.check()) {
					var t = this.uri().replace(/localhost/i,'localhost:3000'),
						e = void 0,
						r = {
							agent: this.agent,
							perMessageDeflate: this.perMessageDeflate
